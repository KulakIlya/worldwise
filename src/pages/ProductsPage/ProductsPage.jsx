import productsImg from '../../assets/img-1.jpg';

import { Section } from './ProductsPage.styled';

const ProductPage = () => {
  return (
    <Section>
      <img src={productsImg} alt="Person with dog overlooking mountain with sunset" width="512" />
      <div>
